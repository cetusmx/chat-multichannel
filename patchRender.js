...
const regex = /\{\s*msg\.type === 'CART_SUMMARY' && msg\.metadata \? \([\s\S]*?\) : null\s*\}\s*\{\s*msg\.type === 'PRODUCT_CARD' && msg\.metadata \? \(/g;

const replacement = `{msg.type === 'CART_SUMMARY' && msg.metadata ? (
